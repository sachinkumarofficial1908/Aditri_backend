...
const companySalarySchema = new mongoose.Schema(
  {
    ...
    // PF and ESIC are fetched from gov_salary
    pf: {
      type: Number,
      required: true,
      default: 0,
...
companySalarySchema.index(
  { employee_id: 1, month: 1, year: 1 },
  { unique: true }
);

// Index for admin queries
companySalarySchema.index({ generated_by_admin: 1, month: 1, year: 1 });

// Index for monthly reports
companySalarySchema.index({ month: 1, year: 1 });
